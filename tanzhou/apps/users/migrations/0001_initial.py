    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='', upload_to='user_image/%Y/%m', verbose_name='头像')),
                ('phone', models.CharField(max_length=11, verbose_name='手机号码')),
                ('qq', models.IntegerField(blank=True, null=True, verbose_name='QQ号码')),
                ('description', models.CharField(blank=True, max_length=400, null=True, verbose_name='用户简介')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='', upload_to='slide_show/%Y/%m', verbose_name='轮播图')),
